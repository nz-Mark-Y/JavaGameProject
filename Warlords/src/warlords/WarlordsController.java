...
public class WarlordsController extends Application {
	...
	public void createNewGame(int oneSelects, boolean oneIsAI, int twoSelects, boolean twoIsAI, int threeSelects, boolean threeIsAI, int fourSelects, boolean fourIsAI) {
		...
		Wall wall11 = new Wall(0, 175, 1);
		Wall wall12 = new Wall(35, 175, 1);
		Wall wall13 = new Wall(70, 140, 1);
		Wall wall14 = new Wall(105, 140, 1);
		Wall wall15 = new Wall(140, 105, 1);
		Wall wall16 = new Wall(140, 70, 1);
		Wall wall17 = new Wall(175, 35, 1);
		Wall wall18 = new Wall(175, 0, 1);
		Wall wall19 = new Wall(35, 140, 1);
		Wall wall110 = new Wall(140, 35, 1);
		Wall wall111 = new Wall(140, 140, 1);
		Wall wall112 = new Wall(105, 105, 1);
		Wall wall113 = new Wall(0, 210, 1);
		Wall wall114 = new Wall(70, 175, 1);
		Wall wall115 = new Wall(175, 70, 1);
		Wall wall116 = new Wall(210, 0, 1);
		Wall wall2 = new Wall(668, 618, 3);
		Wall wall3 = new Wall(100, 618, 0);
		Wall wall4 = new Wall(668, 200, 2);
