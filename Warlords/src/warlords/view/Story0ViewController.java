...
public class Story0ViewController {
	...
	private void loadText() {
		...
		case 2:
			...
			story2.setText("Jake: \t Where are they positioned?");
			story3.setText("-In enemy territory, sir! \n Their chances of survival if we do not interfere is zero!");
			story4.setText("Jake: \t Dog Gamete! We must help them! \n\t Commander, let's dispatch a rescue unit.");
			story5.setText("Jake: \tNo, wait, that will spread out forces, \n\t we can barely afford to dispatch one ship.");
			story6.setText("*You stare at the ceiling*");
			story7.setText("Jake: \t That's it! If only us two go together, we won't \n\t compromise our forces and succeed in bringing them back!");
			story8.setText("Jake: \t Do be careful: they were stationed near where the \n\t apocalypse started, radiation levels may be unusually high.");
			story9.setText("Jake: \t If only the scientific experiment which caused all \n\t this had been stopped earlier...");
			story10.setText("Jake: \t Anyways, let's go rescue the recon team!");
			break;
		case 3:
			title.setText("Chapter 3");
			story1.setText("Jake: \t Dog Gamete, we were too late, \n\tnot even a single bone remains..");
			story2.setText("Jake: \t If only we had arrived sooner...");
			story3.setText("Rob: \t Hahahahaha, I did warn you, my power is absolute!");
			story4.setText("Jake: \t YOU! HOW DARE YOU!");
		...
		case 4:
			...
			story4.setText("Jake: \t We would be dead if we had done that!");
